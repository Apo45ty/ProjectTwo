...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__fullpage_fullpage_component__ = __webpack_require__("./src/app/fullpage/fullpage.component.ts");
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_3__fullpage_fullpage_component__["a" /* FullpageComponent */]
    },
    {
...
var routingComponents = [__WEBPACK_IMPORTED_MODULE_2__test_test_component__["a" /* TestComponent */]];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__display_results_display_results_component__ = __webpack_require__("./src/app/display-results/display-results.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__display_graph_and_result_display_graph_and_result_component__ = __webpack_require__("./src/app/display-graph-and-result/display-graph-and-result.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__dropdown_dropdown_component__ = __webpack_require__("./src/app/dropdown/dropdown.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__fullpage_fullpage_component__ = __webpack_require__("./src/app/fullpage/fullpage.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_7__display_results_display_results_component__["a" /* DisplayResultsComponent */],
                __WEBPACK_IMPORTED_MODULE_8__display_graph_and_result_display_graph_and_result_component__["a" /* DisplayGraphAndResultComponent */],
                __WEBPACK_IMPORTED_MODULE_9__dropdown_dropdown_component__["a" /* DropdownComponent */],
                __WEBPACK_IMPORTED_MODULE_10__navbar_navbar_component__["a" /* NavbarComponent */],
                __WEBPACK_IMPORTED_MODULE_11__fullpage_fullpage_component__["a" /* FullpageComponent */],
            ],
            imports: [
...
var DatabaseGetterService = /** @class */ (function () {
    ...
    DatabaseGetterService.prototype.getTests = function (page) {
        var _this = this;
        var a = this.http.get(this.endpoint + '/getAllRequest/?format=json&page=' + page + '&limit=' + this.limitPerPage);
        a.subscribe(function (data) {
            _this.listData = data;
            _this.loadedData = true;
            for (var i = 0; i < _this.listData.length; i++) {
                try {
                    var eTime = new Date(_this.listData[i].updatedTest.test_end_date);
                    var sTime = new Date(_this.listData[i].updatedTest.test_start_date);
                    _this.listData[i].updatedTest.runtime = eTime - sTime;
                }
                catch (e) {
                    console.log(e);
                }
    ...
    DatabaseGetterService.prototype.runTest = function () {
        var _this = this;
        var a = this.http.get(this.endpoint + '/runTest/');
        a.subscribe(function (data) {
        }, function (error) {
            _this.errorMsg = error;
        });
    ...
    DatabaseGetterService = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_4__angular_router__["a" /* Router */]])
...
/***/ "./src/app/display-graph-and-result/display-graph-and-result.component.css":
/***/ (function(module, exports) {
...
/***/ "./src/app/display-graph-and-result/display-graph-and-result.component.html":
/***/ (function(module, exports) {

module.exports = "\n<div class=\"modal-body row\">\n  <div class=\"col-md-6\">\n    <app-test></app-test>\n  </div>\n  <div class=\"col-md-6\">\n\t<div class=\"col-md-12 centered\">\n\t  <app-dropdown></app-dropdown>\n\t</div>\n    <app-display-results></app-display-results>\n  </div>\n</div>\n"

/***/ }),

/***/ "./src/app/display-graph-and-result/display-graph-and-result.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var DisplayGraphAndResultComponent = /** @class */ (function () {
    ...
    DisplayGraphAndResultComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
...
/***/ "./src/app/display-results/display-results.component.css":
/***/ (function(module, exports) {
...
var DisplayResultsComponent = /** @class */ (function () {
    ...
    DisplayResultsComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            ...
            template: __webpack_require__("./src/app/display-results/display-results.component.html"),
            styles: [__webpack_require__("./src/app/display-results/display-results.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__database_getter_service__["a" /* DatabaseGetterService */]])
    ], DisplayResultsComponent);
    return DisplayResultsComponent;
}());
...
module.exports = "<span>Please select the number of results per page</span>\n<select #option (change)=\"selectChanged(option.value)\" class=\"selectpicker\" style=\"width:100%\">\n  <option >25</option>\n  <option >50</option>\n  <option >100</option>\n  <option >200</option>\n</select>"
...
var DropdownComponent = /** @class */ (function () {
    function DropdownComponent(_databaseService) {
        this._databaseService = _databaseService;
    }
    DropdownComponent.prototype.ngOnInit = function () {
    };
    DropdownComponent.prototype.selectChanged = function (limit) {
...
/***/ "./src/app/fullpage/fullpage.component.html":
/***/ (function(module, exports) {

module.exports = "<app-navbar></app-navbar>\n<app-display-graph-and-result></app-display-graph-and-result>\n"
...
var FullpageComponent = /** @class */ (function () {
    ...
    FullpageComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            ...
            template: __webpack_require__("./src/app/fullpage/fullpage.component.html"),
            styles: [__webpack_require__("./src/app/fullpage/fullpage.component.css")]
        }),
        __metadata("design:paramtypes", [])
    ], FullpageComponent);
...
var NavbarComponent = /** @class */ (function () {
    ...
    NavbarComponent.prototype.runTest = function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("./node_modules/@angular/router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__database_getter_service__ = __webpack_require__("./src/app/database-getter.service.ts");
...
var TestComponent = /** @class */ (function () {
    ...
    TestComponent.prototype.getRequests = function (me) {
        var chartColors = {
            red: 'rgb(255, 99, 132)',
        ...
        me._databaseService.getTests(me.page).subscribe(function (data) {
            ...
            var element = document.getElementById("canvasParrent");
            ...
            for (var i = 0; i < tests.length; i++) {
                ...
                try {
                    var eTime = new Date(tests[i].updatedTest.test_end_date);
                    var sTime = new Date(tests[i].updatedTest.test_start_date);
                    a[i] = eTime - sTime;
                }
                catch (e) {
                    console.log(e);
            ...
            var myLine = new __WEBPACK_IMPORTED_MODULE_3_chart_js__["Chart"](ctx, config);
            myLine.update();
            //Setup donught chart
            var canvas2 = document.getElementById("canvas2");
            var ctx2 = canvas2.getContext("2d");
            config2.data.datasets[0].data = [tests.length - failCount, failCount];
            var myDoughnut = new __WEBPACK_IMPORTED_MODULE_3_chart_js__["Chart"](ctx2, config2);
            myDoughnut.update();
        }, function (error) { return me.errorMsg = error; });
    };
    TestComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__database_getter_service__["a" /* DatabaseGetterService */],
