...
public class Vpoftech_Settings_Bad {
    WebDriver chrome;
    ...
    public void vpoftech_tests_settings_textfields() {
        try {
            ...
            for (int i = 0; i < 2; i++) {
                ...
                chrome.findElement(By.id("input_3")).sendKeys("asasdasdas");
                chrome.findElement(By.id("input_4")).clear();
                chrome.findElement(By.id("input_4")).sendKeys("asdsasdasds");
                chrome.findElement(By.id("input_5")).clear();
                chrome.findElement(By.id("input_5")).sendKeys("122122111!@");
                chrome.findElement(By.id("input_10")).clear();
                chrome.findElement(By.id("input_10")).sendKeys("@#!@#!@#");
                chrome.findElement(By.id("input_11")).clear();
                chrome.findElement(By.id("input_11")).sendKeys("sdw!@#!@#!");
                chrome.findElement(By.id("input_12")).clear();
                chrome.findElement(By.id("input_12")).sendKeys("123@!@#sasd");
                chrome.findElement(By.id("input_13")).clear();
                chrome.findElement(By.id("input_13")).sendKeys("sasd1223!@#!@#");
