...
public class UpdatedDBSingletonDAOImpl implements UpdatedDBSingletonDAO {
	...
	private UpdatedDBSingletonDAOImpl() {
		initDB();
	}
	...
	public static void main(String[] args) {
		...
		// UpdatedTest t = new
		// UpdatedTest(-12L,"TempName","PASSED",false,timestamp,"12:12temp");
		// System.out.println(db.create(t));
		// System.out.println(db.read(3L).toString());
		// UpdatedTest updateTest = new
		// UpdatedTest(3L,"TestUpdate","FAILED",false,timestamp,"temp");
